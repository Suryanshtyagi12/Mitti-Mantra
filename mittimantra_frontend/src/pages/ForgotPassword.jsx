...
const ForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.detail || 'Failed to request OTP. Try again.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen pt-24 pb-12 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-green-50 via-white to-green-50">
      ...
      >
        <div className="text-center">
          <h2 className="mt-2 text-3xl font-extrabold text-gray-900 tracking-tight">Forgot Password?</h2>
          <p className="mt-4 text-sm text-gray-600">Enter your email address and we'll send you an OTP to reset your password.</p>
        </div>
        ...
        <div className="text-center mt-6">
          <Link to="/login" className="font-medium text-green-600 hover:text-green-500 inline-flex items-center transition-colors">
